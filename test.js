...
const MenuStackScreen = () => {
  ...
  const handleIncrement = (supplementPrice) => {
    setTotalPrice(totalPrice + supplementPrice);
  };

  const handleDecrement = (supplementPrice) => {
    setTotalPrice(totalPrice - supplementPrice);
  };
        ...
        <View style={{ flex: 0.3 }}>
          ...
          >
            ...
            <TouchableOpacity
              ...
              onPress={() =>
                navigation.navigate("Encàrrecs", { totalPrice, titulo })
              }
            >
              <Text
